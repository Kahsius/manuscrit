...
\begin{document}
    ...
    \begin{frame}{Machine Learning}
        ...
        \end{itemize}
        Ã€ noter que les domaines ne sont pas exclusifs (apprentissage 
    ...
    \begin{frame}{Clustering: similarité entre individus}
        \begin{itemize}
            ...
            \item La similarité doit Ãªtre \textbf{adaptée à la nature des 
                données}.
        \end{itemize}
    ...
    \begin{frame}{Clustering: types de partitions}
        ...
        appartenances peuvent Ãªtre \textbf{dures}, \textbf{molles} ou 
        \textbf{floues}.
    ...
    \begin{frame}{Clustering: approche multi-vues}
        Apparition d'un nouveau contexte: \textbf{un mÃªme ensemble d'individu} 
    ...
    \begin{frame}{Clustering collaboratif: définition}
        ...
        \begin{itemize}
            \item Les algorithmes utilisés peuvent Ãªtre \textbf{différents}.
    ...
    \section{Clustering collaboratif incrémental}
        ...
        \begin{frame}{Choix de la méthode de clustering}
            ...
            \begin{itemize}
                \item \textbf{$\mathbf{1^{ère}}$ contrainte}: des individus 
                    ...
                    correspondants} oÃ¹ à leurs voisinnages proches.
                \item \textbf{$\mathbf{2^{ème}}$ contrainte}: \textbf{mÃªme 
        ...
        \begin{frame}{SOM: version incrémentale}
            ...
            fait de la seconde contrainte: la topologie doit rester la mÃªme pour 
            toutes les cartes.
    ...
    \begin{frame}{Optimisation de paramètres: définition du problème}
        ...
        \only<4->{Affranchissement des $\alpha$: comme il s'agit de pondérations
            ...
            $\b^* =  \operatornamewithlimits{argmin}_{\b}  \sum_{i \neq j}
        \b_{i,j}  C _{i,j} $}
    \end{frame}
