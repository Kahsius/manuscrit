...
\begin{document}
    ...
    \section{Clustering collaboratif incrémental}
        ...
        \begin{frame}{Clustering collaboratif incrémental: résumé}
            Contributions
            \begin{itemize}
                \item Définition d'une nouvelle méthode de cartes
                    auto-adaptatives incrémentales
                \item Adaptation de la méthode précédente au clustering
                    collaboratif\\~\\
            \end{itemize}
            Perspectives
            \begin{itemize}
    ...
    \begin{frame}{Optimisation des paramètres: résumé}
        \begin{itemize}
            ...
            \item \textbf{Identification des vues bruitées}. 
            \item \textbf{(BONUS)} Apparition de méta-clusters de vues\\~\\
        \end{itemize}
