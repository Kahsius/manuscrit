...
\begin{document}
    ...
    \begin{frame}{Machine Learning}
        ...
        \end{itemize}
        \only<4->{À noter que les domaines ne sont pas exclusifs (apprentissage 
    ...
    \section{Clustering collaboratif incrémental}
        ...
        \begin{frame}{SOM incrémentale et clustering collaboratif}
            ...
            sur \textbf{l'ajout de prototypes} ([Paplinski2012] et 
            [Deng2000]).\\
            ...
            \onslide<2->{
                ...
                \textbf{individus} plutôt que du \textbf{temps}.
                \begin{equation*}
                    \lambda(t) = 
                    \lambda_{min}\left(\frac{\lambda_{max}}{\lambda_{min}}\right)^{\frac{1}{t}}
        ...
        \begin{frame}{SOM incrémentale et clustering collaboratif}
            ...
            \end{center}
            Le nouveau critère dépendant dépendant uniquement des $N_{batch}$ 
        ...
        \begin{frame}{Expérimentations: résultats}
            \begin{table}[!h]
                ...
                \begin{center}
                    \begin{tabular}{cccc}
                              ...
                              collaboratif\\ incrémental\end{tabular} & $\Delta$            
                              \\ \hline
            ...
            \begin{itemize}
                \item \textbf{Score en quantification à long termes 
                    ...
                    résultats locaux.
                \item Le clustering collaboratif permet de \textbf{limiter 
                        l'impact
    ...
    \begin{frame}{Optimisation de paramètres: résultats}
        ...
        dissimilarités sur à la dissimilarité entre les deux vues
        .\\
    ...
    \begin{frame}{Reconstruction collaborative: résumé}
        ...
        \begin{itemize}
            ...
            \item Suffisamment d'information préservée pour permettre
                \textbf{une classification}.
            \item \textbf{Adaptation des masques} suivant la qualité des
                reconstructions.
        \end{itemize}
    \end{frame}
