...
\begin{document}
    ...
    \begin{frame}{Clustering collaboratif: définition}
        \begin{itemize}
            ...
            \item<+-> 2 phases d'apprentissage: la phase \textbf{locale} et la 
                phase \textbf{collaborative}. [Pedrycz2002]
        \end{itemize}
    ...
    \begin{frame}{Optimisation de paramètres: méthode de Karush-Kuhn-Tucker}
        Extension de la méthode du multiplateur de Lagrange aux contraintes d'inégalités
    ...
    \begin{frame}{Reconstruction collaborative: définition}
        \textbf{Objectif}: \textbf{Reconstruire localement} une approximation de l'individu manquant à partir des informations présentes dans \textbf{les vues externes}.
        \begin{figure}[h]
            \centering
    ...
    \begin{frame}{Mise à jour d'une SOM}
        
    \end{frame}

    \begin{frame}{Références}
        \begin{itemize}
            \item [Deng2000] Da Deng and Nikola Kasabov. Esom: An algorithm to
                evolve self-organizing maps from online data streams. In
                \textit{Neural Networks}, volume-6, page 3-8. IEEE, 2000.
            \item [Ghassany2012] Mohammad Ghassany, Nistor Grozavu, and Younès
            ...
            \item [Grozavu2010] Nistor Grozavu and Younès Bennani. Topological
                collaborative clutering. \textit{Australian Journal of
                Intelligent Information Processing Systems}, 12(2), 2010.
            \item [Grozavu2011] Nistor Grozavu, Mohamad Ghassany, and Younès
            ...
            \item [Kuhn1951] Harold W. Kuhn and Albert W. Tucker. Nonlinear
                programming. In \textit{Proceeding of 2nd Berkeley Symposium},
                pages 481-492. 1951.
            \item [Paplinski2012] Andrew P.
    ...
    \begin{frame}{Complexité algorithme du clustering collaboratif}
        ...
        \begin{itemize}
            \item Complexité de chaque algorithme local
            \item Bande passante nécessaire au transfert des résultats intermédiaires proportionnelle au nombre d'individus
            \item Transferts répétés pour chaque itération
        \end{itemize}

        La reconstruction collaborative limite la quantité d'information transférées en ne les transférant qu'une seule fois.

        \begin{itemize}
            \item Apprentissage de chaque autoencodeur
            \item Par vue, apprentissage de $N-1$ perceptron multi-couches
            \item Par vue, apprentissage de $N-1$ masques
        \end{itemize}
    \end{frame}
