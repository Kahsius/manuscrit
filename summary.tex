...
\begin{figure}[h]
    \centering
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o0}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o1}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o2}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o3}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o4}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o5}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o6}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o7}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o8}}
    \subfloat[][]{\includegraphics[scale=.07]{img/sample_original/o9}}
