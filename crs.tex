...
This Section presents the experiments that have been conducted to test our proposed method.\@ First are presented in Section~\ref{sec:datasets} the datasets which have been used during the experiments, then the global methodology used to analyze the system behavior is described in Section~\ref{sec:methodo}. The measures used to quantify the results are presented in Section~\ref{sec:measures}, and finally numeric results are presented in Section~\ref{sec:results}.
	...
	\subsection{Datasets}
\label{sec:datasets}
To get empirical results of the Collaborative Reconstruction System, we use it on three different datasets usable in a multi-view context:
...
\label{fig:msemrd}
    \centering
    \subfloat[][WDBC]{\includegraphics[scale=.30]{img/mse_wdbc}\label{fig:mse_a}}
    \qquad
    \subfloat[][WDBC]{\includegraphics[scale=.30]{img/mrd_wdbc}\label{fig:mrd_a}}\\
    \subfloat[][MFDD]{\includegraphics[scale=.30]{img/mse_mfeat}\label{fig:mse_b}}
    \qquad
    \subfloat[][MFDD]{\includegraphics[scale=.30]{img/mrd_mfeat}\label{fig:mrd_b}}\\
    \subfloat[][Madelon]{\includegraphics[scale=.30]{img/mse_madelon}\label{fig:mse_c}}
    \qquad
    \subfloat[][Madelon]{\includegraphics[scale=.30]{img/mrd_madelon}\label{fig:mrd_c}}\\
    \subfloat[][Cube]{\includegraphics[scale=.30]{img/mse_cube}\label{fig:mse_d}}
    \qquad
    \subfloat[][Cube]{\includegraphics[scale=.30]{img/mrd_cube}\label{fig:mrd_d}}
...
\begin{figure}[H]
    \centering
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o0}}
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o1}}
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o2}}
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o3}}
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o4}}\\
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o5}}
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o6}}
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o7}}
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o8}}
    \subfloat[][]{\includegraphics[scale=.15]{img/sample_original/o9}}
